  ...
  return (
    <>
      <section className="home">
        <img src="assets/mount2.png" className="mount2" alt="mount2" />
        <img src="assets/mount1.png" className="mount1" alt="mount1" />
        <img src="assets/bush2.png" className="bush2" alt="bush2" />
        <img src="assets/bush1.png" className="bush1" alt="bush1" />
